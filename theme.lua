...
local aa = {
    ...
    [49] = function()
        ...
        return {
            Name = "Aqua",
            Accent = Color3.fromRGB(50, 150, 150),  -- ทำให้สีเด่นขึ้น ดูสง่างามมากขึ้น
            AcrylicMain = Color3.fromRGB(10, 10, 20),  -- สีเข้มให้ความรู้สึกเท่และลึกลับ
            AcrylicBorder = Color3.fromRGB(40, 90, 90),  -- ขอบสีที่เข้มกว่า เพื่อเพิ่มความแตกต่าง
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(50, 130, 130), Color3.fromRGB(30, 60, 60)),  -- ไล่สีให้เข้มขึ้นเพื่อเพิ่มความลึก
            AcrylicNoise = 0.85,  -- ลดความชัดเจนของ Noise เพื่อให้ดูเรียบขึ้น
            TitleBarLine = Color3.fromRGB(50, 110, 110),  -- สีที่ให้ความเข้มเพื่อความเท่
            Tab = Color3.fromRGB(120, 170, 170),  -- ทำให้สี Tab เข้มขึ้นเพื่อให้ดูสะดุดตา
            Element = Color3.fromRGB(90, 140, 140),  -- สีของ Element ที่เข้มกว่าเพื่อให้ดูชัดเจน
            ElementBorder = Color3.fromRGB(30, 60, 60),  -- ขอบของ Element ที่เข้มขึ้น
            InElementBorder = Color3.fromRGB(70, 100, 100),  -- ขอบภายในที่มีสีเข้มขึ้นเพื่อความคมชัด
            ElementTransparency = 0.78,  -- ลดความโปร่งใสเพื่อให้ดูเข้มขึ้น
            ToggleSlider = Color3.fromRGB(90, 140, 140),  -- สีของ Toggle ที่เข้มขึ้นเพื่อให้ดูสะดุดตา
            ToggleToggled = Color3.fromRGB(10, 10, 10),  -- สีเข้มเมื่อเปิด Toggle เพื่อให้ดูชัดเจน
            SliderRail = Color3.fromRGB(90, 140, 140),  -- สีของ Slider Rail ที่เข้มขึ้น
            DropdownFrame = Color3.fromRGB(140, 180, 180),  -- สีของ Dropdown Frame ที่ดูสะอาดและเรียบง่าย
            DropdownHolder = Color3.fromRGB(30, 60, 60),  -- สีของ Holder ที่เข้มเพื่อให้โดดเด่น
            DropdownBorder = Color3.fromRGB(30, 55, 55),  -- สีของขอบ Dropdown ที่เข้มขึ้นเพื่อความสวยงาม
            DropdownOption = Color3.fromRGB(90, 140, 140),  -- สีของตัวเลือก Dropdown ที่เข้มกว่าเพื่อให้เด่น
            Keybind = Color3.fromRGB(90, 140, 140),  -- สีของ Keybind ที่สอดคล้องกับธีม
            Input = Color3.fromRGB(90, 140, 140),  -- สีของ Input ที่เข้มขึ้นเพื่อความคมชัด
            InputFocused = Color3.fromRGB(15, 5, 25),  -- สีเมื่อ Input โฟกัส ให้ความรู้สึกลึกลับ
            InputIndicator = Color3.fromRGB(120, 160, 160),  -- สีที่เข้มขึ้นสำหรับ Indicator เพื่อความโดดเด่น
            Dialog = Color3.fromRGB(30, 60, 60),  -- สีของ Dialog ที่เข้มเพื่อให้ดูเข้ากับธีม
            DialogHolder = Color3.fromRGB(20, 50, 50),  -- สีของ Holder ที่เข้มขึ้นเพื่อให้ดูเท่
            DialogHolderLine = Color3.fromRGB(20, 45, 45),  -- สีของเส้นใน Dialog ที่เข้มเพื่อความแตกต่าง
            DialogButton = Color3.fromRGB(30, 60, 60),  -- สีของปุ่ม Dialog ที่ดูแข็งแกร่ง
            DialogButtonBorder = Color3.fromRGB(70, 100, 100),  -- สีของขอบปุ่มที่เข้มเพื่อความคมชัด
            DialogBorder = Color3.fromRGB(40, 90, 90),  -- สีของขอบ Dialog ที่เข้มเพื่อความชัดเจน
            DialogInput = Color3.fromRGB(35, 80, 80),  -- สีของ Input ใน Dialog ที่เข้ม
            DialogInputLine = Color3.fromRGB(120, 160, 160),  -- สีของเส้น Input ที่ชัดเจนเพื่อความโดดเด่น
            Text = Color3.fromRGB(230, 230, 230),  -- สีข้อความที่เข้มขึ้นเล็กน้อยเพื่อให้ดูไม่จ้าจนเกินไป
            SubText = Color3.fromRGB(150, 150, 150),  -- สีของ SubText ที่เข้มเพื่อให้กลมกลืน
            Hover = Color3.fromRGB(90, 140, 140),  -- สีเมื่อ Hover เพื่อให้ความรู้สึกเข้มและสะดุดตา
            HoverChange = 0.05  -- การเปลี่ยนสีเมื่อ Hover ที่เด่นชัดขึ้นเล็กน้อย
        }        
    end,
    [50] = function()
